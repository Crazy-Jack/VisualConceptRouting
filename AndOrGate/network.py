...
class Generator(nn.Module):
    ...
    def __init__(self, z_dim, hidden_dim=64, out_channel=3):
        ...
        self.sparse3 = nn.Identity() # TODO: change sparse operation; k = 8 * 8 / 4
        self.block4 = BasicBlockUp(hidden_dim * 8, hidden_dim * 4) # [bsz, 64 * 4, 16, 16]
        self.sparse4 = nn.Identity() # TODO: change sparse operation; k = 16 * 16 / 4
        self.block5 = ResBlockUp(hidden_dim * 4, hidden_dim * 2) # [bsz, 64 * 2, 32, 32]
        self.sparse5 = nn.Identity() # TODO: change sparse operation; k = 32 * 32 / 4
