...
datapath='Path-of-your-data'
#datapath='./Dataset/stlimgall'
special='SparsegeneratorAEadv10k64ResnonormCelebA'
...
modelpath=dir+'/Results/'+dataname+'/'+'params'+special+'/'+'model.ckpt-1100'
